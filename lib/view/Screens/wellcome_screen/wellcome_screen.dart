                      ...
                      children: [
                        Flexible(
                          child: Padding(
                            ...
                            child: Text(AppString.anonymous,
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    height: 170,
                    width: 170,
                    child: const Image(image:AssetImage("assets/images/welcome_logo.png",),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                  ...
                  children: [
                    CustomElevatedButton(onPressed: (){},
                     buttonWidth: MediaQuery.of(context).size.width,
                      titleText: AppString.talkToTherapist,
                     ...
                     Text.rich(
                      TextSpan(
                        children: [
                           TextSpan(
                            text: AppString.alreadySignedUp,//'Already signed up?',
                    ...
                    Text.rich(
                      TextSpan(
                        children: [
                          TextSpan(
                            text: AppString.areyouTherapist,
                          ...
                          TextSpan(
                            ...
                            recognizer: TapGestureRecognizer()..onTap=(){
                            Get.toNamed(AppRoute.wellcome_two_screen);
                          },
                            style: GoogleFonts.inter(
                              color: const Color(0xFF1DA822),
                              fontSize: 16,
